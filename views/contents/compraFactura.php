...
<div class="content">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12">
                <a class="btn btn-danger" href="<?=BASE?>compra/listar">
                        ...
                        <div class="factura">
                            <div class="factura-header">
                                ...
                                <div class="factura-header-prov" style="overflow: auto;">
                                    ...
                                    <span>Proveedor: <b id="compra_proveedor"></b></span>
                                    <span>Fecha de compra: <b id="compra_fecha"></b></span>
                                </div>
                            </div>
...
<script src="<?=BASE?>views/dist/js/scripts/compraFactura.js"></script>