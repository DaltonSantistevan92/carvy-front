...
<div class="content">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-12">
                <a class="btn btn-primary" href="<?=BASE?>compra/nueva">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 form-group">
                <label for="">Filtrar Compras Por: </label>
                <select id="filtrar_comprar" class="form-control">
...
<script src="<?=BASE?>views/dist/js/scripts/listaCompra.js"></script>