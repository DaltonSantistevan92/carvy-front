...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Vehículos Reparados</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Reportes</a></li>
                    <li class="breadcrumb-item active">Vehículos Reparados</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-6 col-md-4 col-lg-3 form-group">
                ...
                <input type="date" class="form-control" id="date-reparado-inicio">
            </div>
            <div class="col-6 col-md-4 col-lg-3 form-group">
                <label for="">Hasta</label>
                <input type="date" class="form-control" id="date-reparado-fin">
            </div>
            <div class="col-6 col-md-4 col-lg-3">
                <label for="">Marca</label>
                <select class="form-control" id="date-vehiculo-marca">
            ...
            <div class="col-6 col-md-4 col-lg-3" style="margin-top: 32px;">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary active">
                        <input type="radio" name="options" id="reparado-play">
                        <i class="fas fa-play"></i>
                    </label>
                    <label class="btn btn-danger">
                        <input type="radio" name="options" id="reparado-pdf">
            ...
            <div class="col-12 mt-3">
                <div class="row">
                    ...
                    <div class="col-6 col-md-8 col-lg-9 " style="padding-left: 125px">
                        ...
                        <h6 style="margin-left: 126px;">REPORTE DE VEHÍCULOS REPARADOS POR MARCA</h6>
                        ...
                        <div class="mt-3">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="text-info">Lista de Vehículos Reparados</h5>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody id="body-vehiculo-reparado">
                                            <!-- <tr>
                                                <td>1</td>
                                                <td>asas</td>
                                                <td>5</td>
...
<script src="<?=BASE?>views/dist/js/scripts/reporteVehiculoReparado.js"></script>